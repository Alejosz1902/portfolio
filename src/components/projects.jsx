        ...
        <div id='projects' className="w-full mx-auto md:mt-16 px-8 md:w-3/5">
            <div className="flex flex-col space-y-8 mt-12 text-start">
                ...
                <div className="flex flex-col items-center space-y-4">
                    <div className="flex flex-col w-full bg-darkBlue p-4 rounded-lg md:flex-row-reverse md:space-x-4 md:space-y-0">
                        <div className="flex flex-col justify-end md:h-auto md:w-1/2 p-0 md:p-4">
                            <img src={bookmarkImg} alt="bookmark-projext" srcset="" className="object-contain rounded-lg"/>
                            <div className="flex flex-row space-x-4 w-full mt-4 md:mt-8">
                        ...
                        <div className="flex flex-col w-full py-4 px-2 md:w-1/2 mx-auto">
                            <h3 className="text-2xl text-white font-bold hover:text-grayishBlue">Bookmark Project</h3>
